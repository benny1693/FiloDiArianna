...
$user = init();
$narticle = $_GET['articleID'];

new ArticlePage($narticle, )
print_r($_SESSION);
print_r($article);
?>
<!DOCTYPE html>
		...
		<section id="articolo">
			...
			<div id="article-content">
				...
				<div id="article-title">
					...
					<p id="article-author">Scritto da <a href="profilopubblico.php">Autore</a></p>
				</div>
				...
				<div id="article-references">
                    ...
                    <?php $user->printRelatedPages($article->getArticleID); ?>
					<ul>
						<li><a>link pag correlata</a></li>
					</ul>
				</div>
			</div>
