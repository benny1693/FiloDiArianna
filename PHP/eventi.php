...
<head>
	<meta name="title" content="Eventi | Filo di Arianna" />
		...
		<section>
			...
			<ul id="macrocategories">
				<li id="dei">
					...
					<h2><a href="epocadei.php">Epoca degli Dei</a></h2>
					<ul class="categories">
				...
				<li id="uomini">
					...
					<h2><a href="epocauomini.php">Epoca degli Dei e degli Uomini</a></h2>
					<ul class="categories">
						<li><a href="articolo.php">articolo1</a></li>
						<li><a href="articolo.php">articolo2</a></li>
					</ul>
				...
				<li id="eroi">
					...
					<h2><a href="epocaeroi.php">Epoca degli Eroi</a></h2>
					<ul class="categories">
						<li><a href="articolo.php">articolo1</a></li>
						<li><a href="articolo.php">articolo2</a></li>
					</ul>
